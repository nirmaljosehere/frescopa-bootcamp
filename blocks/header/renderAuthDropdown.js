...
export function renderAuthDropdown(navTools) {
 ...
 <div class="dropdown-wrapper nav-tools-wrapper">
  ...
  // Standalone "Sign in" link shown next to the account icon when logged out
  const signInLink = document.createElement('a');
  signInLink.className = 'nav-signin-link';
  signInLink.href = rootLink(CUSTOMER_LOGIN_PATH);
  signInLink.textContent = 'Sign in';
  navTools.append(signInLink);
