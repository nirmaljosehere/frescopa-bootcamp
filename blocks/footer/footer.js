...
export default async function decorate(block) {
  ...
  // footer fragment within that prefix; otherwise default to the site root.
  const contentPrefix = window.location.pathname.startsWith('/content/') ? '/content' : '';
  const footerPath = footerMeta ? new URL(footerMeta, window.location).pathname : `${contentPrefix}/footer`;
